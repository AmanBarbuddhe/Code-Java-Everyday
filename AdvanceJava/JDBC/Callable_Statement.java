/*
	...
	*******************************************************************************************************************************************************
	...
	It is recommended to use CallableStatement instead of PreparedStatement because if we had written this method(msg()) or any other method on oracle ,
	there PreparedStatement would have failed because here we are using "select msg()" to call msg() function , but in oracle to call a function,
	we use "CALL KEYWORD" i.e. "call msg()" and psql doesnt support call , because PreparedStatement is used to execute sql statements and "CALL" 
...
public class Callable_Statement {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Output : " + rs.getString(1));     // for rno also rs.getString() will work because System.out.println converts anything into a string 
			...
			/*
			           ...
			           msg                      equivaent to                rno
			  ------------------------------							------------
 				   Hello World                  							103        for this we would have written ---> rs.getString("rno") or rs.getString(1)
